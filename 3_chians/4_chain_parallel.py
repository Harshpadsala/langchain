...
summary_template = ChatPromptTemplate.from_messages(
    [
        ('system', 'you are a webseries critic'),
        ('human',"provide breif summary of movie {serise_name}")
    ]
)
...
def analyze_plot(plot):
    plot_template = ChatPromptTemplate.from_messages(
        [
            ("system", "You are a series critic."),
...
result = chain.invoke({'serise_name':'game of thrones'})
print(result)
